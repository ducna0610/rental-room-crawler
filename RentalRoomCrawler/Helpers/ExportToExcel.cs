...
namespace RentalRoomCrawler.Helpers;

public static class ExportToExcel<T>
{
    public static void GenerateExcel(List<T> listData, string path, string sheetName = "sheet1")
    {
        ...
        // ws.Workbook.Properties.Author = "ducna0610";
